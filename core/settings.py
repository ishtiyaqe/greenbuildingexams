...
SECRET_KEY = 'django-insecure-%^hi&vcaoziy8wbos0^cnu!56-d)=f70%0hucup1g6w@i^doxn'
...
SESSION_COOKIE_NAME = '192.168.0.111'  # You can choose your own name

# Define the session cookie domain (e.g., 'localhost' for development)
SESSION_COOKIE_DOMAIN = '192.168.0.111'  # Update this to your domain in a production environment
...
CSRF_COOKIE_DOMAIN = '192.168.0.111'  # Update this to your domain in a production environment
